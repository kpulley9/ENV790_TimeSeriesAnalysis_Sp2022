...
electricity_price<- read_csv(file="Data/Average_retail_price_of_electricity_United_States_monthly.csv",header = TRUE,skip = 4)
...
#comparing all previous models, always looking for lowest aic
print(compare_aic)
```
