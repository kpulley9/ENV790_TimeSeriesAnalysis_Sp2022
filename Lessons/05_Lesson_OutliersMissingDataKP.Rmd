...
#everything outside these lines can be tested for outliers
  #but we dont actually know which points- see next chunk
...
inflow_random$inflow <- rm.outlier(inflow_random$inflow,fill=TRUE) #using fill equal true the value will be replaced by mean or median (replace without removing(removing is not ok))
